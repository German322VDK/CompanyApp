...
using CompanyApp.Domain.ViewModels;
...
namespace CompanyApp.Infrastructure.Tests.Services.Stores.Employees
{
    public class EmployeesDBStoreTests
    {
        private readonly DbContextOptions<CompanyAppDbContext> _options;
        ...
        public EmployeesDBStoreTests()
        {
            ...
            _options = new DbContextOptionsBuilder<CompanyAppDbContext>()
        ...
        {
            using CompanyAppDbContext context = new CompanyAppDbContext(_options);
