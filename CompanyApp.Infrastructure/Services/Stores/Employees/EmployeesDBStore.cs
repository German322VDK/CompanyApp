...
using CompanyApp.Infrastructure.Services.Mapping;

namespace CompanyApp.Infrastructure.Services.Stores.Employees
{
    /// <summary>
    ...
    public class EmployeesDBStore : IEmployeesStore
    {
        ...
        public EmployeesDBStore(CompanyAppDbContext dbContext, ILogger<EmployeesDBStore> logger)
        {
